...
function(build_tgfx_single_config SOURCE_PATH NODEJS OUTPUT_DIR IS_DEBUG)
    ...
    if("swiftshader" IN_LIST FEATURES)
    ...
    if("no-opengl" IN_LIST FEATURES)
        list(APPEND BUILD_ARGS -DTGFX_USE_OPENGL=OFF)
    endif()

    if("no-threads" IN_LIST FEATURES)
    ...
    elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "wasm32")
        # For WebAssembly, use wasm-mt by default unless no-threads feature is specified
        if("no-threads" IN_LIST FEATURES)
            set(ARCH "wasm")
