...
function(build_tgfx_single_config SOURCE_PATH NODEJS OUTPUT_DIR IS_DEBUG)
    ...
    elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "wasm32")
        # For WebAssembly, use wasm-mt by default unless disable-threads feature is specified
        if("disable-threads" IN_LIST FEATURES)
            set(ARCH "wasm")
